...
export function ReadingContainer({ paragraph }: { paragraph: string[] }) {
  ...
  return (
    <>
      <nav className="fixed right-[50px] top-[50px] flex w-full flex-col items-end gap-10">
      ...
      <div className="flex flex-col items-center justify-center">
        {pause && (
          <span className="text-xl font-light text-[#bdbdbd]">
            Mali Princ - Odlomak
          </span>
        )}
        <motion.h1 className="text-7xl font-bold">{word}</motion.h1>
      </div>
    </>
  );
}
